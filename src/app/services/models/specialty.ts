...
export class Specialty implements Audit {
  ...
  public CreateListSpecialty() {
    ...
    list.push(new Specialty({
      dateCreation: new Date("2019-01-14"), dateModification: new Date("2020-02-16"), userCreation: "ADMIN", userModification: "ADMIN",
      name: "INFECTOLOGIA", description: "description", code: 3, avatar: "http://www.amofac.org/cursos/pluginfile.php/2678/course/overviewfiles/2.png"
    }));
    list.push(new Specialty({
      dateCreation: new Date("2019-01-14"), dateModification: new Date("2020-02-16"), userCreation: "ADMIN", userModification: "ADMIN",
      name: "NEUMOLOGIA", description: "description", code: 4, avatar: "https://st.depositphotos.com/3356953/4654/v/600/depositphotos_46547529-stock-illustration-lungs-sign.jpg"
    }));
    list.push(new Specialty({
      dateCreation: new Date("2019-01-14"), dateModification: new Date("2020-02-16"), userCreation: "ADMIN", userModification: "ADMIN",
      name: "NEUROLOGIA", description: "description", code: 5, avatar: "https://thumbs.dreamstime.com/z/tecnolog%C3%ADa-de-red-inteligente-artificial-la-neurolog%C3%ADa-logo-template-141613248.jpg"
    }));
    list.push(new Specialty({
      dateCreation: new Date("2019-01-14"), dateModification: new Date("2020-02-16"), userCreation: "ADMIN", userModification: "ADMIN",
      name: "PSIQUIATRIA", description: "description", code: 6, avatar: "https://st2.depositphotos.com/5665934/8873/v/600/depositphotos_88738868-stock-illustration-maze-of-human-mind.jpg"
    }));
    return list;
  }
}
